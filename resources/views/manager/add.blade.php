                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    ...
                                    <input type="text" class="form-control" name="id" placeholder="Product ID..." value="{{old('id')}}">
                                    @error('id')
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                        ...
                                        <input type="text" class="form-control mb-1" name="img_path" placeholder="File Name..." id="filename">
