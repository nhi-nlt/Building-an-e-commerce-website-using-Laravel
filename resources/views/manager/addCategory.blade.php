            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a class="has-arrow waves-effect waves-dark active" href="{{ route('admin.blog.add') }}" aria-expanded="false"><i class="fa fa-leaf"></i><span class="hide-menu">Add New Blog</span></a>
                        </li>
                    </ul>
                </nav> 
            </div>
                        ...
                        {{-- <div class="container"> --}}
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    ...
                                    <input type="text" class="form-control" name="category_code" placeholder="Category Code..." value="{{old('category_code')}}">
                                    @error('category_code')
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    ...
                                    <textarea id="mytextarea" class="form-control" name="category_description" placeholder="Description..."  value="{{old('category_description')}}"></textarea>
